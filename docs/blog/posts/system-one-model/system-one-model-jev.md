...
# System One Models and Jev: AI That Returns Decisions, Not Text
...
*Editable source: [jev-architecture.drawio](assets/jev-architecture.drawio)*
...
*Editable source: [llm-vs-system-one.drawio](assets/llm-vs-system-one.drawio)*
